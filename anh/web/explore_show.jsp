...
<html lang="en" class="h-100">
                                            ...
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 mix ${event.getEventName()} concert workshops volunteer sports health_Wellness" data-ref="mixitup-target">
                                                <div class="main-card mt-4">
                                                    <div class="event-thumbnail">
                                                        ...
                                                        <span  class="bookmark-icon "  table="Bookmark " onClick="addToCart('${event.getEventId()}')">️</span>
                                                    </div>
    ...
    function updateCartCount() {
        ...
        if (cartCountElement) {
            fetch('getcartcount') // Cần tạo một Servlet khác để lấy số lượng sản phẩm trong giỏ hàng
