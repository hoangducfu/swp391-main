                                    ...
                                    <div class="offcanvas-body">
                                        <div class="offcanvas-top-area">
                                         ...
                                         <ul class="navbar-nav justify-content-end flex-grow-1 pe_5">
                                            <li class="nav-item">
                                                <a class="nav-link" href="EventofStaff.jsp">
                                                    <i ></i>Sự kiện của tôi
                                                </a>
                                            </li>
...
>>>>>>> Stashed changes
            ...
            <div class="nav">
                ...
                <div class="act">
                    <a href="CreateEvent_Ticket.jsp">Tạo sự kiện</a>
                </div>
                <div class=' act'>
                    <a href="EventofStaff.jsp">Sự kiện của tôi</a>
                </div>
                <div class="account">
                    <li class="dropdown account-dropdown order-3">
                        <a href="#" class="account-link" role="button" id="accountClick" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <div class="left_section menu_left" id="js-menu">
                <div class="left_section">
                    <ul>
                        ...
                        <li class="menu--item">
                            <a href="StaffProfile.jsp" class="menu--link" title="About" data-bs-toggle="tooltip" data-bs-placement="right">
