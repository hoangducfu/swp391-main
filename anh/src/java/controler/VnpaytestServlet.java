...
public class VnpaytestServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet VnpaytestServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet VnpaytestServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//            DAO_event paynemt = new DAO_event();
        ...
        if (discountCode != null && discountCode.trim() != "") {
            String err = "";
            int discountAmount = Integer.parseInt(amount);
            try {
                DiscountDAO d = new DiscountDAO();
                if (d.checkDiscountByCode(discountCode)) {
                    discountAmount = (int) (discountAmount * 0.9);  
