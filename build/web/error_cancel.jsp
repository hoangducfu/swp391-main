						...
						<div class="booking-confirmed-content">
							<div class="main-card">
								<div class="booking-confirmed-top text-center p_30">
									...
									<h4>Vé đang được xử lý </h4>
									<p class="ps-lg-4 pe-lg-4">Bạn đã gửi yêu cầu hủy với vé này vui lòng đợi xử lý</p>
								...
								<div class="booking-confirmed-bottom">
									<div class="booking-confirmed-bottom-bg p_30">
                                                                            ...
                                                                            <a class="main-btn btn-hover h_50 w-100 mt-5" href="payment_history?user_name="${user.username}>DONE</a>
