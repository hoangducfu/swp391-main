...
public class EventDAO extends DBContext {
   ...
   public int getNumberPage() {
    ...
    public List<Event> getPaging(int index) {
    List<Event> data = new ArrayList<>();
    String sql = "SELECT * FROM Event ORDER BY EventID OFFSET ? ROWS FETCH NEXT 8 ROWS ONLY";
    try (PreparedStatement st = connection.prepareStatement(sql)) {
        ...
        try (ResultSet rs = st.executeQuery()) {
            while (rs.next()) {
                ...
                String locationId = String.valueOf(rs.getString("LocationID"));
                String timeStart = String.valueOf(rs.getTimestamp("TimeStart"));
                String timeEnd = String.valueOf(rs.getTimestamp("TimeEnd"));
                String priceType1 = String.valueOf(rs.getInt("PriceType1"));
                String priceType2 = String.valueOf(rs.getInt("PriceType2"));
                String priceType3 = String.valueOf(rs.getInt("PriceType3"));
                String accountId = String.valueOf(rs.getInt("AccountID"));
                String statusDisable = String.valueOf(rs.getBoolean("StatusDisable"));
                Event e = new Event(eventId, categoryID, eventName, description, eventImg, locationId, timeStart, timeEnd, priceType1, priceType2, priceType3, accountId, statusDisable);
                data.add(e);
            }
        }
