                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12">
                        <div class="event-filter-items">
                            <div class="featured-controls">
                                <div class="controls">
                                    <% 
              List<String> favoriteProducts = (List<String>) request.getAttribute("favoriteProducts");
              if (favoriteProducts != null && !favoriteProducts.isEmpty()) {
                  for (String productId : favoriteProducts) {
                      out.println("<li>" + productId + "</li>");
                  }
              } else {
                  out.println("<li>Không có sản phẩm yêu thích nào.</li>");
              }
                                    %>
                                </div>
                            </div>
