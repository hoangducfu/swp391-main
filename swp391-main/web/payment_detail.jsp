									...
									<div class="row">
										...
										<div class="col-md-6">
											<div class="vhls140">
												<ul>
													<li>
														<div class="vdt-list">Thanh toán tới ${user.username}</div>
													</li>
									...
									<div class="table-responsive">
										<table class="table">
											...
											<tbody>
													...
													<tr>
														<td>${payed.payment_id}</td>
														<td>${payed.transaction_description}</td>
														<td>${payed.status}</td>
											...
											<div class="booking-confirmed-bottom-bg p_30">
												<div class="event-order-dt">
													...
													<div class="event-order-dt-content">
														...
														Tổng tiền:<div class="buyer-name">${payed.amount}</div>
