<%-- 
    ...
    Created on : Jun 12, 2024, 9:15:08 AM
    Author     : mactu
--%>
...
<head>
        ...
        <c:set var="event_detail" value="${requestScope.event_detail}"/>
				...
				<div class="row">
					<div class="col-xl-12 col-lg-12 col-md-12">
						<div class="event-top-dts">
							<div class="event-top-dt">
								<h3 class="event-main-title">${event_detail.event_date}, ${event_detail.event_time} </h3>
								<div class="event-top-info-status">
									<span class="event-type-name"><i class="fa-solid fa-location-dot"></i>${event_detail.event_location}</span>
									<span class="event-type-name details-hr">Starts on <span class="ev-event-date">${event_detail.event_date}, ${event_detail.event_time}</span></span>
					...
					<div class="col-xl-8 col-lg-7 col-md-12">
						<div class="main-event-dt">
							<div class="event-img">
								<img src="images/event-imgs/${event_detail.event_img}" alt="">		
							</div>
					...
					<div class="col-xl-4 col-lg-5 col-md-12">
						<div class="main-card event-right-dt">
							...
							<div class="event-dt-right-group">
								...
								<div class="event-dt-right-content">
									<h4>Date and Time</h4>
									<h5>${event_detail.event_date}, ${event_detail.event_time}</h5>
...
<!--										<ul class="dropdown-menu">
							...
							<div class="event-dt-right-group">
								...
								<div class="event-dt-right-content">
									<h4>Location</h4>
									<h5 class="mb-0">${event_detail.event_location}</h5>
                                                                        <a href="https://www.google.com/maps/search/${event_detail.event_location}" target="_blank"><i class="fa-solid fa-location-dot me-2"></i>View Map</a>
								</div>
							</div>
