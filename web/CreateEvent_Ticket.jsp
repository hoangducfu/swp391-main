                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 col-md-12">
                                                        <div class="form-group border_bottom pb_30">
                                                            ...
                                                            <input class="form-control h_50" type="text" placeholder="Enter event name here" name="nameEvent" value="${o.name}">
                                                        </div>
                                                        <div class="form-group border_bottom pt_30 pb_30">
                                                            <label class="form-label fs-16">Thể loại của sự kiện*</label>
                                                            <select class="selectpicker" multiple="" data-selected-text-format="count > 4" data-size="5" title="Select category" name="categoryID" data-live-search="true">
                                                        ...
                                                        <div class="form-group border_bottom pt_30 pb_30">
                                                            ...
                                                            <div class="row g-2">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="loc-group position-relative">
                                                                        <input class="form-control h_50 datepicker-here" data-language="en" type="datetime-local" placeholder="MM/DD/YYYY" name="timeStart" value="${o.TimeStart}">
                                                                ...
                                                                <div class="price-ticket-card-head d-md-flex flex-wrap align-items-start justify-content-between position-relative p-4">
                                                                    <div class="d-flex align-items-center top-name">
                                                                        <div class="icon-box">
                                                                            ...
                                                                            <input name="ve1" type="text"><!-- comment -->
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="price-ticket-card-head d-md-flex flex-wrap align-items-start justify-content-between position-relative p-4">
                                                                    <div class="d-flex align-items-center top-name">
                                                                        <div class="icon-box">
                                                                            ...
                                                                            <input name="ve2" type="text"><!-- comment -->
                                                                        </div>
                                                                    </div>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="price-badge">
                                                                ...
                                                                <div class="price-ticket-card-head d-md-flex flex-wrap align-items-start justify-content-between position-relative p-4">
                                                                    <div class="d-flex align-items-center top-name">
                                                                        <div class="icon-box">
                                                                            ...
                                                                            <input name="ve3" type="text"><!-- comment -->
                                                                        </div>
                                                                    </div>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="price-badge">
