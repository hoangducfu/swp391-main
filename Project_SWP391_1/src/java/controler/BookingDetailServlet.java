...
public class BookingDetailServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            List<BookingDetail> lst = bookingDetailDAO.getBookingDetailByBookingId(bookingId);
            request.setAttribute("lst", lst);
            request.getRequestDispatcher("booking_detail.jsp").forward(request, response);
        } catch (Exception e) {
              Logger.getLogger(BookingDetailServlet.class.getName()).log(Level.SEVERE, null, e);
        }
    } 
