...
<html lang="en" class="h-100">
                    ...
                    <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 col-md-12">
                                                    <div class="form-group mt-4">
                                                        ...
                                                        <input class="form-control h_50" type="text" name="name" placeholder="" required="" autofocus="">																								
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6 col-md-12">
                                                    <div class="form-group mt-4">
                                                        ...
                                                        <input class="form-control h_50" type="text" name="phone" placeholder="" required="">																								
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-12">
                                                    <div class="form-group mt-4">
                                                        <label class="form-label">Email</label>
                                                        <input class="form-control h_50" type="email" name="email" placeholder="" required="">																								
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-12">
                                                    <div class="form-group mt-4">
                                                        <label class="form-label">Địa chỉ</label>
                                                        <input class="form-control h_50" type="text" name="address" placeholder="" required="">																								
                                                    </div>
                                                </div>
                        ...
                        <div class="col-xl-4 col-lg-12 col-md-12">
                            <div class="main-card order-summary">
                                ...
                                <input type="hidden" value="${t.event.eventId}" name="eventId">
                                <input type="hidden" value="${t.area.price}" name="unitPrice">
                                <div class="order-summary-content p_30">
                                    <div class="event-order-dt">
                                        <div class="event-thumbnail-img">
                                            <img src="images/event-imgs/${t.event.eventImg}" alt="">
                                        </div>
                                        <div class="event-order-dt-content">
                                            <h5>${t.event.eventName}</h5>
                                            <span>${t.event.date} ${t.event.time}</span>
                                            <div class="category-type">${t.event.category.categoryName}</div>
                                        </div>
                                    </div>
                                    <div class="order-total-block">
                                        <div class="order-total-dt">
                                            <div class="order-text">Area</div>
                                            <div class="quantity">
                                                <div class="counter">
                                                    ${t.area.areaName}
                                                </div>
                                    ...
                                    <div class="order-total-block">
                                        <div class="order-total-dt">
                                            ...
                                            <div class="quantity">
                                                <div class="counter">
                                                    ...
                                                    <input type="text" value="1" id="inputQuantity" name="quantity">
                                        ...
                                        <div class="order-total-dt">
                                            <div class="order-text">Unit Price</div>
                                            <div class="order-number">$${t.area.price}</div>
                                        </div>
                                        <div class="divider-line"></div>
                                        <div class="order-total-dt">
                                            <div class="order-text">Total</div>
                                            <div class="order-number ttl-clr" id="total">$${t.area.price}</div>
                                        </div>
                                    </div>
    ...
    <script type="text/javascript">function increaseCount(a, b) {
                                                            ...
                                                            totalDisplay.textContent = '$' + (value * `${t.area.price}`).toFixed(1);
                                                        }
