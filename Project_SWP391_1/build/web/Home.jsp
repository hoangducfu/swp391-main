                               ...
                               <ul class="navbar-nav">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-submenu">
                                        ...
                                        <li><a class="dropdown-item" href="contact_us.jsp">Liên hệ với chúng tôi</a></li>
                                    </ul>
                                </li>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-submenu">
                                        <li><a class="dropdown-item" href="#">Thông tin về chúng tôi </a></li>
                                        <li><a class="dropdown-item" href="contact_us.jsp">Điều khoản và điều kiện</a></li>
                                        <li><a class="dropdown-item" href="contact_us.jsp">Chính sách bảo mật</a></li>
                    ...
                    <div class="event-filter-items">
                        <div class="featured-controls">
                            ...
                            <div class="row" data-ref="event-filter-content">
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 mix sports concert volunteer arts" data-ref="mixitup-target">
                                    <div class="main-card mt-4">
                                        ...
                                        <div class="event-content">
                                            <a href="event_detail.jsp" class="event-title">Trainee Program on Leadership' 2022</a>
                                            <div class="duration-price-remaining">
                            ...
                            <div class="browse-btn">
                                <a href="Home.jsp" class="main-btn btn-hover ">Browse All</a>
                            </div>
                        </div>
                    </div>
                </div>
					...
					<div class="col-lg-3 col-md-6">
						<div class="footer-content">
							...
							<ul class="footer-link-list">
								<li><a href="#" class="footer-link">Giúp đỡ</a></li>
